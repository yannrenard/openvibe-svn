...
// For Mister Vincent !
...

				{
					...
					/* Options :
					/*   -p : plays the scenario at start
					/*   -pf : plays the scenario "fast forward" at start
					/*
					/* If the option is not recognized, the designer stops
					/* Without any parameter, the designer starts with a new empty scenario
					/************************************************************************/
						
					bool b_OptionFound = false;
					switch(argc)
					{
						case 2:
							cout<<"[  INF  ] Opening scenario "<<argv[1]<<endl;
						...
						case 3:
							...
							{
								b_OptionFound = true;
								cout<<"[  INF  ] Opening and playing scenario "<<argv[2]<<endl;
							...
							{
								b_OptionFound = true;
								cout<<"[  INF  ] Opening and playing fast scenario "<<argv[2]<<endl;
								app.openScenario(argv[2]);
...
/************************************************************************/
/* Designer parameters: [option] <path-to-a-scenario>
/* Options :
/*   -p : plays the scenario at start
/*   -pf : plays the scenario "fast forward" at start
/*
