#ifndef __OpenViBE_AcquisitionServer_CDriverEyelink_H__
#define __OpenViBE_AcquisitionServer_CDriverEyelink_H__
...
{
	class CDriverEyelink : public OpenViBEAcquisitionServer::IDriver
	{
	public:

		CDriverEyelink(OpenViBEAcquisitionServer::IDriverContext& rDriverContext);
		virtual ~CDriverEyelink(void);
	...
	private:
		OpenViBE::boolean readSection(const void* pSection);
