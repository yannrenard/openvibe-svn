...
namespace OpenViBEAcquisitionServer
{
	...
	protected:
		virtual OpenViBE::boolean readBrainampHeader(void);
		...
		OpenViBEAcquisitionServer::CDriverBrainAmpScalpEEG::RDA_MessageHeader m_structRDA_MessageHeader;
		...
		char* m_pcharStructRDA_MessageBuffer;
	};
};
