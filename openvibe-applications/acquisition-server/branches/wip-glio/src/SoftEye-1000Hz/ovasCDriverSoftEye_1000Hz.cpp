...
// Buffer de reception
eyelink_type1000 reception_buffer_SoftEye_1000Hz_struct[NB_SAMPLES];

// Buffer d'initialisation
synchro_type1000 Struct_init;
	...
	IDriverCallback& rCallback)
{
	...
	//m_pSample=new openvibe_type1000[NB_SAMPLES];
	//std::cout << "Sizeof struct openvibe_type1000 : " << sizeof(openvibe_type1000)/sizeof(float32)	<< std::endl;
	//system("pause");
	//m_pSample=(openvibe_type1000)
...
void CDriverSoftEye_1000Hz::dump(openvibe_type1000* pSample,	eyelink_type1000* pEyelink)
{
	...
	*/
	...
	if(oct==sizeof(reception_buffer_SoftEye_1000Hz_struct))
	{
		...
		//printf("\nPrepare data...\n");
			...
			eyelink_type1000* pEyelink=reception_buffer_SoftEye_1000Hz_struct;
...
boolean CDriverSoftEye_1000Hz::configure(void)
{
	...
	CConfigurationSoftEye_1000Hz m_oConfiguration("../share/openvibe-applications/acquisition-server/interface-SoftEye1000Hz.ui", m_ui32DriftCorrectionState);
	// else
	//CConfigurationSoftEye_1000Hz m_oConfiguration("../share/openvibe-applications/acquisition-server/interface_SoftEye1000Hz.ui");
