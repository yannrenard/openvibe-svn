#ifndef __OpenViBE_AcquisitionServer_CDriverSoftEye_500Hz_H__
#define __OpenViBE_AcquisitionServer_CDriverSoftEye_500Hz_H__
...
//"""""""""""""""""""""""""""""""""""""""
namespace Standard_SoftEye_500Hz
{
typedef struct
...
namespace OpenViBEAcquisitionServer
{
	...
	class CDriverSoftEye_500Hz : public OpenViBEAcquisitionServer::IDriver
	{
	public:

		CDriverSoftEye_500Hz(OpenViBEAcquisitionServer::IDriverContext& rDriverContext);//modif new Idriver
	...
	protected:
		...
		void dump(openvibe_type500* pSample,	eyelink_type500* pEyelink);
	...
	protected:
		...
		OpenViBE::boolean m_bTCP_IP_link_Opened;
		OpenViBE::uint32 m_ui32cptWaitTCP_IP;
		OpenViBE::uint32 m_ui32SampleCountPerSentBlock;
		OpenViBE::float32* m_pSample;
		//openvibe_type500* m_pSample;
...
#endif // __OpenViBE_AcquisitionServer_CDriverSoftEye_500Hz_H__
