...
#define OVAS_ConfigureGUI_File   "../share/openvibe-applications/acquisition-server/interface-Neuroscan-Synamps2.ui"
...
CDriverNeuroscanSynamps2::CDriverNeuroscanSynamps2(IDriverContext& rDriverContext): IDriver(rDriverContext)
	,m_pCallback(NULL)
