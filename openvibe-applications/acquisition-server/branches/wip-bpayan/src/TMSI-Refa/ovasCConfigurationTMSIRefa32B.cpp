...
boolean CConfigurationTMSIRefa32B::preConfigure(void)
{
	...
	colList = gtk_tree_view_column_new_with_attributes("Devices List",
          rendererList, "text", 0, NULL);
	...
	gtk_tree_selection_set_mode(gtk_tree_view_get_selection(m_pViewList),
