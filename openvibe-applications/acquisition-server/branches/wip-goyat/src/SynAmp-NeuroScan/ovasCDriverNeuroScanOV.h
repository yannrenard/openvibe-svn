#ifndef __OpenViBE_AcquisitionServer_CDriverNeuroScanOV_H__
#define __OpenViBE_AcquisitionServer_CDriverNeuroScanOV_H__
...
{
	class CDriverNeuroScanOV : public OpenViBEAcquisitionServer::IDriver
	{
	public:

		CDriverNeuroScanOV(OpenViBEAcquisitionServer::IDriverContext& rDriverContext);
		virtual ~CDriverNeuroScanOV(void);
...
#define m_pHeader (&o_pHeader)
		...
		CDriverNeuroScanOV:: RDA_MessageHeader	swapIt			(RDA_MessageHeader l_structRDA_MessageHeader);
...
//Simon says;-): to solve the error message "warning C4103 filename : alignment changed after including header" solution http://msdn.microsoft.com/en-us/library/t4d0762d(VS.80).aspx 
#pragma pack(pop)
#endif // __OpenViBE_AcquisitionServer_CDriverNeuroScanOV_H__
