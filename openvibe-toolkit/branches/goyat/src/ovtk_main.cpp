...
boolean OpenViBEToolkit::initialize(const IKernelContext& rKernelContext)
{
	...
	l_rTypeManager.registerEnumerationEntry(OV_TypeId_Stimulation, "OVTK_StimulationId_VisualSteadyStateStimulationStart_bis", OVTK_StimulationId_VisualSteadyStateStimulationStart);
	l_rTypeManager.registerEnumerationEntry(OV_TypeId_Stimulation, "OVTK_StimulationId_VisualSteadyStateStimulationStop_bis", OVTK_StimulationId_VisualSteadyStateStimulationStop);
