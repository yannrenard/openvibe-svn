#include "ovtkCConnectivityAlgorithm.h"
...
boolean CConnectivityAlgorithm::initialize(void)
{
	...
	ip_ui64SamplingRate1.initialize(this->getInputParameter(OVTK_Algorithm_Connectivity_InputParameterId_ui64SamplingRate1));
	ip_ui64SamplingRate2.initialize(this->getInputParameter(OVTK_Algorithm_Connectivity_InputParameterId_ui64SamplingRate2));
	ip_pChannelPairs.initialize(this->getInputParameter(OVTK_Algorithm_Connectivity_InputParameterId_LookupMatrix));
	op_pMatrix.initialize(this->getInputParameter(OVTK_Algorithm_Connectivity_OutputParameterId_OutputMatrix));
