...
#include "ovpCOfflineStatisticalAnalysis.h"
...
COfflineStatisticalAnalysis::COfflineStatisticalAnalysis(void)
	:m_oSignalReaderCallbackProxy(*this
		,&COfflineStatisticalAnalysis::setChannelCount
		,&COfflineStatisticalAnalysis::setChannelName
		,&COfflineStatisticalAnalysis::setSampleCountPerBuffer
		,&COfflineStatisticalAnalysis::setSamplingRate
		,&COfflineStatisticalAnalysis::setSampleBuffer)
	,m_oStimulationReaderCallbackProxy(*this
		,&COfflineStatisticalAnalysis::setStimulationCount
		,&COfflineStatisticalAnalysis::setStimulation)
...
OpenViBE::boolean COfflineStatisticalAnalysis::initialize()
{
	...
	getBoxAlgorithmContext()->getStaticBoxContext()->getSettingValue(10, m_oOutputFilename);
	getBoxAlgorithmContext()->getStaticBoxContext()->getSettingValue(11, m_oOnlineScenarioName);
	...
	getBoxAlgorithmContext()->getStaticBoxContext()->getSettingValue(19, l_oParameter);
...
void COfflineStatisticalAnalysis::release(void)
{
	delete this;
}

boolean COfflineStatisticalAnalysis::processInput(uint32 ui32InputIndex)
{
	getBoxAlgorithmContext()->markAlgorithmAsReadyToProcess();
	return true;
}

boolean COfflineStatisticalAnalysis::process(void)
{
...
CIdentifier COfflineStatisticalAnalysis::getStimulationIdentifierTrialStart(void)
{
...
CIdentifier COfflineStatisticalAnalysis::getStimulationIdentifierTrialEnd(void)
{
...
CIdentifier COfflineStatisticalAnalysis::getStimulationIdentifierTrialLabelRangeStart(void)
{
...
CIdentifier COfflineStatisticalAnalysis::getStimulationIdentifierTrialLabelRangeEnd(void)
{
...
CIdentifier COfflineStatisticalAnalysis::getStimulationIdentifierTrain(void)
{
...
boolean COfflineStatisticalAnalysis::train(ISignalTrialSet& rTrialSet)
{
...
OpenViBE::boolean COfflineStatisticalAnalysis::generateScenario()
{
