#ifndef __OpenViBEPlugins_Offline_COfflineClassifierTest_H__
#define __OpenViBEPlugins_Offline_COfflineClassifierTest_H__
...
namespace OpenViBEPlugins
{
	namespace Offline
	{
		class COfflineClassifierTest : virtual public OpenViBEToolkit::TTrainingBoxAlgorithm<OpenViBE::Plugins::IBoxAlgorithm>
		{
		public:

			COfflineClassifierTest(void);
			virtual ~COfflineClassifierTest(void);
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TTrainingBoxAlgorithm<OpenViBE::Plugins::IBoxAlgorithm>, OVP_ClassId_OfflineClassifierTest)
		...
		class COfflineClassifierTestDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }
			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("Offline classifier test"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_OfflineClassifierTest; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Offline::COfflineClassifierTest(); }
				...
				OpenViBE::Kernel::IBoxProto& rPrototype) const
			{
				...
				rPrototype.addSetting("Classifier", OVTK_TypeId_Filename, "../../Classifier.txt");

				rPrototype.addSetting("Feedback start", OV_TypeId_Float, "4");
				rPrototype.addSetting("Feedback end", OV_TypeId_Float, "8");

				rPrototype.addSetting("Window width", OV_TypeId_Float, "4");
				rPrototype.addSetting("Window step", OV_TypeId_Float, "1");
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_OfflineClassifierTestDesc)
		};
	};
};
...
#endif // __OpenViBEPlugins_Offline_COfflineClassifierTest_H__
