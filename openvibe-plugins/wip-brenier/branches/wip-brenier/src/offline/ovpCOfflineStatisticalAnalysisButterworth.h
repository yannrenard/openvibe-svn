#ifndef __SamplePlugin_COfflineStatisticalAnalysisButterworth_H__
#define __SamplePlugin_COfflineStatisticalAnalysisButterworth_H__
...
#include <LogBP_IIR.h>
#include <LogBP_Butterworth.h>

namespace OpenViBEPlugins
{
	namespace Offline
	{
		class COfflineStatisticalAnalysisButterworth : virtual public OpenViBEToolkit::TTrainingBoxAlgorithm<OpenViBE::Plugins::IBoxAlgorithm>
		{
		public:

			COfflineStatisticalAnalysisButterworth(void);
			virtual ~COfflineStatisticalAnalysisButterworth(void);
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TTrainingBoxAlgorithm<OpenViBE::Plugins::IBoxAlgorithm>, OVP_ClassId_OfflineStatisticalAnalysisButterworth)
			...
			LogBP_Butterworth m_oBandPower;
		...
		class COfflineStatisticalAnalysisButterworthDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }
			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("Offline frequency band selection"); }
			virtual OpenViBE::CString getAuthorName(void) const          { return OpenViBE::CString("Fabien Lotte, Bruno Renier"); }
			virtual OpenViBE::CString getAuthorCompanyName(void) const   { return OpenViBE::CString("INRIA/IRISA/INSA"); }
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("Perform statistical analysis in order to identify the most discriminant frequency bands, for further classification and use of corresponding band power features in a BCI"); }
			virtual OpenViBE::CString getDetailedDescription(void) const { return OpenViBE::CString("Perform statistical analysis in order to identify the most discriminant frequency bands, for further classification and use of corresponding band power features in a BCI"); }
			virtual OpenViBE::CString getCategory(void) const            { return OpenViBE::CString("Offline"); }
			virtual OpenViBE::CString getVersion(void) const             { return OpenViBE::CString("0.1"); }

			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_OfflineStatisticalAnalysisButterworth; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Offline::COfflineStatisticalAnalysisButterworth(); }
				...
				OpenViBE::Kernel::IBoxProto& rPrototype) const
			{
				...
				rPrototype.addSetting("Subtrial length", OV_TypeId_Float, "1");
				rPrototype.addSetting("Subtrial step", OV_TypeId_Float, "0.1");
				...
				rPrototype.addSetting("Output filename", OVTK_TypeId_Filename, "../../BandPowerButterworthConf.txt");
				rPrototype.addSetting("Online scenario", OVTK_TypeId_Filename, "../../featureExtractionButterworth.xml");
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_OfflineStatisticalAnalysisButterworthDesc)
		};
	};
};
...
#endif // __SamplePlugin_COfflineStatisticalAnalysisButterworth_H__
