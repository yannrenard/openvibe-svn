#ifndef __OpenViBEPlugins_Offline_COfflineLDAButterworthTraining_H__
#define __OpenViBEPlugins_Offline_COfflineLDAButterworthTraining_H__
...
namespace OpenViBEPlugins
{
	namespace Offline
	{
		class COfflineLDAButterworthTraining : virtual public OpenViBEToolkit::TTrainingBoxAlgorithm<OpenViBE::Plugins::IBoxAlgorithm>
		{
		public:

			COfflineLDAButterworthTraining(void);
			virtual ~COfflineLDAButterworthTraining(void);
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TTrainingBoxAlgorithm<OpenViBE::Plugins::IBoxAlgorithm>, OVP_ClassId_OfflineLDAButterworthTraining)
		...
		class COfflineLDAButterworthTrainingDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }
			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("Offline LDA classifier training"); }
			virtual OpenViBE::CString getAuthorName(void) const          { return OpenViBE::CString("Bruno Renier, Fabien Lotte"); }
			virtual OpenViBE::CString getAuthorCompanyName(void) const   { return OpenViBE::CString("INRIA/IRISA"); }
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("Train the LDA classifier on band power features extracted using the butterworth filter."); }
			virtual OpenViBE::CString getDetailedDescription(void) const { return OpenViBE::CString("Train the LDA classifier on band power features extracted using the butterworth filter, for EEG segment spamming the feedback period of each trial. The classifier is then tested on these data"); }
			virtual OpenViBE::CString getCategory(void) const            { return OpenViBE::CString("Offline"); }
			virtual OpenViBE::CString getVersion(void) const             { return OpenViBE::CString("0.1"); }

			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_OfflineLDAButterworthTraining; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Offline::COfflineLDAButterworthTraining(); }
				...
				OpenViBE::Kernel::IBoxProto& rPrototype) const
			{
				...
				// Adds box settings
				rPrototype.addSetting("Feature extractor", OVTK_TypeId_Filename, "../../BandPowerButterworthConf.txt");
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_OfflineLDAButterworthTrainingDesc)
		};
	};
};
...
#endif // __OpenViBEPlugins_Offline_COfflineLDAButterworthTraining_H__
