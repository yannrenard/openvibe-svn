#ifndef __OpenViBEPlugins_BoxAlgorithm_MatrixOperation_H__
#define __OpenViBEPlugins_BoxAlgorithm_MatrixOperation_H__
...
namespace OpenViBEPlugins
{
	...
	{
		class CBoxAlgorithmMatrixOperation : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
			typedef enum
			{	NB_ENTRIES = 3,
			...
			CBoxAlgorithmMatrixOperation(void);
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_MatrixOperation);
		...
		protected:
			OpenViBE::Kernel::IAlgorithmProxy*				m_pAlgorithmMatrixOperation;
		...
		class CBoxAlgorithmMatrixOperationDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("MatrixOperation"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_MatrixOperation; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::WipGionescu::CBoxAlgorithmMatrixOperation; }

			virtual OpenViBE::boolean getBoxPrototype(
				OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
				for(int ii=0; ii < CBoxAlgorithmMatrixOperation::NB_ENTRIES; ii++)
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_MatrixOperationDesc);
		};
	};
};

#endif // __OpenViBEPlugins_BoxAlgorithm_MatrixOperation_H__
