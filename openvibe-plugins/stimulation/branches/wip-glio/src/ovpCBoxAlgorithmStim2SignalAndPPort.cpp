#include "ovpCBoxAlgorithmStim2SignalAndPPort.h"
...
// Init stim2sig. ----------------------------------------------------------------------------------------------------------------------------
OpenViBE::boolean CBoxAlgorithmStim2SignalAndPPort::initialize(void)
{
...
// UnInit stim2sig.  ----------------------------------------------------------------------------------------------------------------------------
OpenViBE::boolean CBoxAlgorithmStim2SignalAndPPort::uninitialize(void)
{
...
OpenViBE::boolean CBoxAlgorithmStim2SignalAndPPort::processInput(uint32 ui32InputIndex)
{
...
////> Process stim2sig. ----------------------------------------------------------------------------------------------------------------------------
OpenViBE::boolean CBoxAlgorithmStim2SignalAndPPort::process(void)
{
