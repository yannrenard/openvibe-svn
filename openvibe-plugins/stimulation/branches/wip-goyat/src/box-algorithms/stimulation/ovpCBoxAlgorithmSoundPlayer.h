...
protected:
		...
		public:
			...
			virtual OpenViBE::boolean onSettingAdded(OpenViBE::Kernel::IBox& rBox, const OpenViBE::uint32 ui32Index)
			{
				...
				rBox.addSetting("", OV_TypeId_Stimulation, "OVTK_StimulationId_Beep");
				rBox.addSetting("", OV_TypeId_Filename, "../share/openvibe-plugins/stimulation/ov_beep.wav");
		...
		public:
				...
				OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
				...
				rBoxAlgorithmPrototype.addSetting("sound trigger",  OV_TypeId_Stimulation, "OVTK_StimulationId_Beep");
				rBoxAlgorithmPrototype.addSetting("sound path", OV_TypeId_Filename, "../share/openvibe-plugins/stimulation/ov_beep.wav");
