...
//___________________________________________________________________//
//                                                                   //
#define OVP_ClassId_BoxAlgorithm_FieldtripBuffer                                      OpenViBE::CIdentifier(0x7147AA85, 0x48085CC0)
#define OVP_ClassId_BoxAlgorithm_FieldtripBufferDesc                              OpenViBE::CIdentifier(0x91FA0EAB, 0xF7B45B3F)
//___________________________________________________________________//
//                                                                   //
// Gloabal defines                                                   //
//___________________________________________________________________//
