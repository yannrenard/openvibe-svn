...
#include "../../../../../cmake-modules/ovp_global_defines.h"

///local/flotte/These/code/OpenViBE/openvibe/openvibe-plugins/samples/branches/wip-flotte/src
///local/flotte/These/code/OpenViBE/openvibe/cmake-modules
