...
namespace OpenViBEPlugins
{
	namespace Samples
	{
		class CBoxAlgorithmMeanVariance : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
		...
		class CBoxAlgorithmMeanVarianceDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:
			...
			virtual OpenViBE::CString getCategory(void) const            { return OpenViBE::CString("Statistics"); }
