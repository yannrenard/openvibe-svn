#ifndef __OpenViBEPlugins_SignalProcessing_CChannelNameModifier_H__
#define __OpenViBEPlugins_SignalProcessing_CChannelNameModifier_H__
...
namespace OpenViBEPlugins
{
	namespace SignalProcessing
	{
		...
		class CSignalDescription2
		{
			public:

				CSignalDescription2(void)
		...
		*/
		class CChannelNameModifier : public OpenViBEToolkit::TBoxAlgorithm<OpenViBE::Plugins::IBoxAlgorithm>, virtual public OpenViBEToolkit::IBoxAlgorithmSignalInputReaderCallback::ICallback
		{
		public:

			CChannelNameModifier(void);
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithm, OVP_ClassId_ChannelNameModifier)
		...
		public:
			...
			std::vector<std::string> m_vChannelNewNames;

			// Needed to write on the plugin output
			EBML::IWriter* m_pWriter;

			EBML::TWriterCallbackProxy1<OpenViBEPlugins::SignalProcessing::CChannelNameModifier> m_oSignalOutputWriterCallbackProxy;
			...
			CSignalDescription2 * m_pSignalDescription;	//! Structure containing information about the signal stream
		...
		*/
		class CChannelNameModifierDesc : public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }
			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("Channel Name Modifier"); }
			...
			virtual OpenViBE::CString getShortDescription(void) const    { return OpenViBE::CString("change channel names"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_ChannelNameModifier; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::SignalProcessing::CChannelNameModifier(); }

			virtual OpenViBE::boolean getBoxPrototype(OpenViBE::Kernel::IBoxProto& rPrototype) const
			{
				rPrototype.addInput("Input signal", OV_TypeId_Signal);
				rPrototype.addOutput("Filtered signal", OV_TypeId_Signal);
				rPrototype.addSetting("Channels list", OV_TypeId_String, "0");
				rPrototype.addSetting("Selection by index", OV_TypeId_Boolean, "true");
				rPrototype.addSetting("new Names", OV_TypeId_String, "");

				return true;
			}

			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_ChannelNameModifierDesc)
		};
	}
}

#endif // __SamplePlugin_CChannelNameModifier_H__
