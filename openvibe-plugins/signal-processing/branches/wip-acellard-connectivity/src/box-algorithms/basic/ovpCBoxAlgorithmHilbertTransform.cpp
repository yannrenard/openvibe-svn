#include "ovpCBoxAlgorithmHilbertTransform.h"
...
boolean CBoxAlgorithmHilbertTransform::initialize(void)
{
...
boolean CBoxAlgorithmHilbertTransform::uninitialize(void)
{
...
/*
boolean CBoxAlgorithmHilbertTransform::processClock(IMessageClock& rMessageClock)
{
...
/*
uint64 CBoxAlgorithmHilbertTransform::getClockFrequency(void)
{
...
boolean CBoxAlgorithmHilbertTransform::processInput(uint32 ui32InputIndex)
{
	// some pre-processing code if needed...
...
boolean CBoxAlgorithmHilbertTransform::process(void)
{
